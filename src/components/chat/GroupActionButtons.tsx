...
export function GroupActionButtons({ openAddMember, onLeaveGroup }: GroupActionButtonsProps) {
  return (
    <View className="flex-row gap-3 mb-5">
      ...
      <TouchableOpacity onPress={onLeaveGroup} className="bg-red-50 border border-red-200/60 px-5 rounded-xl flex-row items-center justify-center gap-1.5 active:bg-red-100/55">
